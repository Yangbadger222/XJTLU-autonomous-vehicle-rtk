...
KILL_PATTERN := '[l]aunch_with_logs.sh|[r]os2 launch|[m]onitor_corridor_status(\.py)?|[r]os2 bag|[r]viz2|[l]ivox_ros_driver2_node|[l]io_node|[l]ocalizer_node|[i]nitialpose_relocalize_bridge(\.py)?|[n]av2_cloud_retime(\.py)?|[p]go_node|[r]tk_fgo_node|[f]go_gil_time_sync_node|[f]go_gil_lidar_frontend_node|[r]tk_map_odom_corrector|[s]erial_twistctl_node|[s]erial_reader_node|[n]mea_serial_driver|[u]m982_rtk_node|[u]m982_raw_node|[p]lanner_server|[c]ontroller_server|[b]ehavior_server|[b]t_navigator|[s]moother_server|[v]elocity_smoother|[l]ifecycle_manager|[w]aypoint_follower|[m]ap_server|[a]mcl|[c]omponent_container(_mt)?|[g]ps_route_runner|[g]ps_global_aligner|[g]ps_anchor_localizer|[r]oute_server|[g]oal_manager_node|[r]obot_state_publisher|[j]oint_state_publisher|[p]ointcloud_to_laserscan|[a]sync_slam_toolbox_node|[m]ap_saver_server|[f]rc_health_aggregator|[f]rc_event_marker|[f]rc_risk_pipeline|[f]rc_memory_manager|[f]rc_trial_runner'
...
# ==============================================================================
launch-slam launch-explore launch-indoor-nav launch-corridor launch-explore-gps launch-nav-gps launch-rtk-basic launch-rtk-raw launch-fgo-gil-time-sync launch-fgo-gil-lidar launch-tightly-coupled launch-travel:
...
build-sensor:
	$(COLCON_BUILD) --packages-select \
		...
		nmea_msgs nmea_navsat_driver um982_rtk_driver gnss_raw_msgs um982_raw_driver \
		gnss_calibration wheeltec_gps_path
