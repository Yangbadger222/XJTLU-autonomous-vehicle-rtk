...
MODE="${1:-explore}"
EXTRA_LAUNCH_ARGS=("${@:2}")
UM982_MIXED_PARAMS_FILE="${FYP_UM982_MIXED_PARAMS_FILE:-${FYP_UM982_RAW_PARAMS_FILE:-}}"
...
cleanup_runtime_nodes() {
  pkill -INT -f '[r]os2 launch|[r]os2 bag|[r]viz2|[l]ivox_ros_driver2_node|[l]io_node|[l]ocalizer_node|[i]nitialpose_relocalize_bridge(\.py)?|[n]av2_cloud_retime(\.py)?|[p]go_node|[r]tk_fgo_node|[f]go_gil_time_sync_node|[f]go_gil_lidar_frontend_node|[f]go_gil_float_fgo_node|[r]tk_map_odom_corrector|[s]erial_twistctl_node|[s]erial_reader_node|[n]mea_serial_driver|[u]m982_rtk_node|[u]m982_raw_node|[p]lanner_server|[c]ontroller_server|[b]ehavior_server|[b]t_navigator|[s]moother_server|[v]elocity_smoother|[l]ifecycle_manager|[w]aypoint_follower|[m]ap_server|[a]mcl|[c]omponent_container(_mt)?|[g]ps_route_runner|[g]ps_global_aligner|[g]ps_anchor_localizer|[r]oute_server|[g]oal_manager_node|[r]obot_state_publisher|[j]oint_state_publisher|[p]ointcloud_to_laserscan|[a]sync_slam_toolbox_node|[m]ap_saver_server|[m]onitor_corridor_status|[f]rc_health_aggregator|[f]rc_event_marker|[f]rc_risk_pipeline|[f]rc_memory_manager|[f]rc_trial_runner' 2>/dev/null || true
  sleep 1
  pkill -KILL -f '[r]os2 launch|[r]os2 bag|[r]viz2|[l]ivox_ros_driver2_node|[l]io_node|[l]ocalizer_node|[i]nitialpose_relocalize_bridge(\.py)?|[n]av2_cloud_retime(\.py)?|[p]go_node|[r]tk_fgo_node|[f]go_gil_time_sync_node|[f]go_gil_lidar_frontend_node|[f]go_gil_float_fgo_node|[r]tk_map_odom_corrector|[s]erial_twistctl_node|[s]erial_reader_node|[n]mea_serial_driver|[u]m982_rtk_node|[u]m982_raw_node|[p]lanner_server|[c]ontroller_server|[b]ehavior_server|[b]t_navigator|[s]moother_server|[v]elocity_smoother|[l]ifecycle_manager|[w]aypoint_follower|[m]ap_server|[a]mcl|[c]omponent_container(_mt)?|[g]ps_route_runner|[g]ps_global_aligner|[g]ps_anchor_localizer|[r]oute_server|[g]oal_manager_node|[r]obot_state_publisher|[j]oint_state_publisher|[p]ointcloud_to_laserscan|[a]sync_slam_toolbox_node|[m]ap_saver_server|[m]onitor_corridor_status|[f]rc_health_aggregator|[f]rc_event_marker|[f]rc_risk_pipeline|[f]rc_memory_manager|[f]rc_trial_runner' 2>/dev/null || true
...
if [[ "$MODE" == "rtk-raw" && -n "$UM982_MIXED_PARAMS_FILE" ]]; then
  LAUNCH_ARGS+=("params_file:=${UM982_MIXED_PARAMS_FILE}")
fi
...
if [[ "$MODE" == "fgo-gil-shadow" && -n "$UM982_MIXED_PARAMS_FILE" ]]; then
  LAUNCH_ARGS+=("um982_params_file:=${UM982_MIXED_PARAMS_FILE}")
fi
